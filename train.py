...
def main():
    ...
    mAP_model = Create_Yolo(
        input_size=YOLO_INPUT_SIZE, CLASSES=TRAIN_CLASSES
    ...
    for epoch in range(TRAIN_EPOCHS):
        for image_data, target in trainset:
            ...
            print(
                "epoch:{:2.0f} step:{:5.0f}/{}, lr:{:.6f}, giou_loss:{:7.2f}, conf_loss:{:7.2f}, prob_loss:{:7.2f}, total_loss:{:7.2f}".format(
                    epoch,
                    cur_step,
                    steps_per_epoch,
                    results[1],
        ...
        count, giou_val, conf_val, prob_val, total_val = 0.0, 0, 0, 0, 0
        ...
        print(
            "\n\ngiou_val_loss:{:7.2f}, conf_val_loss:{:7.2f}, prob_val_loss:{:7.2f}, total_val_loss:{:7.2f}\n\n".format(
                giou_val / count, conf_val / count, prob_val / count, total_val / count
            )
        )
        ...
        if TRAIN_SAVE_CHECKPOINT and not TRAIN_SAVE_BEST_ONLY:
            save_directory = os.path.join(
                ...
                TRAIN_MODEL_NAME + "_val_loss_{:7.2f}".format(total_val / count),
            )
